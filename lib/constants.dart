...
class Constants{
  ...
  // colors
  static const Color primarycolor = Color(0xFF20194C);
  static const Color secondarycolor = Color(0xFF777A95);
  static const Color blackcolor = Color(0xFF000000);
  static const Color whitecolor = Color(0xFFFFFFFF);
  static const Color colorTextLight = Color(0xFF918D8D);
  static Color getPrimaryColor(BuildContext context) {
    return  Color(0xFF20194C);
  }
  static Color getGreyColor(BuildContext context) {
    return  Color(0xFFD0F1DD);
  }
  ...
  static const Color COLOR_PRIMARY = Color(0xFF20194C);
